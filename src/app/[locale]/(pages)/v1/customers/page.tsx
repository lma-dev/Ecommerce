...
import CustomerTable from "@/v1/customers/_components/CustomerTable";
  ...
  return (
    <div>
      <div className="p-6 space-y-4">
        <h1 className="text-2xl font-semibold">Customer Lists</h1>
        <CustomerTable showDialog={showDialog} t={t} />
      </div>
      {dialog.type && (
        <ConfirmDialog
          open={dialog.open}
