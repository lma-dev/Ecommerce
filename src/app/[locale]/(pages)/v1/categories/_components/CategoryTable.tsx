    ...
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-4">
        <div className="flex items-center justify-between md:hidden">
          ...
          <Link href={`/${locale}/v1/categories/create`} className="inline-flex items-center">
        ...
        <Link href={`/${locale}/v1/categories/create`} className="hidden md:inline-flex items-center md:self-auto self-end">
          <Button>{t("createCategory")}</Button>
        </Link>
      </div>
